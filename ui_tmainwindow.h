...
public:
    ...
    void setupUi(QMainWindow *TMainWindow)
    {
        ...
        spinBox_Y->setMinimumSize(QSize(120, 0));

        gridLayout->addWidget(spinBox_Y, 3, 3, 1, 1);
        ...
        gridLayout->addWidget(spinBox_X, 1, 1, 1, 1);
        ...
        spinBox_4->setMinimumSize(QSize(120, 0));
        ...
        gridLayout->addWidget(label_13, 0, 0, 1, 4);

        spinBox_3 = new QSpinBox(centralWidget);
        spinBox_3->setObjectName(QStringLiteral("spinBox_3"));
        spinBox_3->setMinimumSize(QSize(120, 0));
        ...
        gridLayout_2->addWidget(spinBox_Step, 6, 0, 1, 3);
    ...
    void retranslateUi(QMainWindow *TMainWindow)
    {
        ...
        pushButton->setText(QApplication::translate("TMainWindow", "Move", nullptr));
