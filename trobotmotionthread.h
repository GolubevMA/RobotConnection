...
//------------------------------------------------------------------------------
typedef QList<float> TPoint;
//------------------------------------------------------------------------------
class TRobotMotionThread : public QThread
{
    Q_OBJECT
public:
    ...
    explicit TRobotMotionThread(QObject *parent = nullptr, QString ip = "");
    ~TRobotMotionThread();
    ...
    int LinearMove(QList<TPoint> &points);
