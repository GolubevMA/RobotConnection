...
public:
    ...
    void setupUi(QWidget *FormRemote)
    {
        ...
        pushButton = new QPushButton(frame_Trac);
        ...
        gridLayout_4->addLayout(gridLayout_2, 0, 3, 6, 1);
    ...
    void retranslateUi(QWidget *FormRemote)
    {
        ...
        pushButton->setText(QCoreApplication::translate("FormRemote", "test", nullptr));
